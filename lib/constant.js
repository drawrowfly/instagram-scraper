...
module.exports = {
    scrapeType: ['user', 'hashtag', 'location', 'comments', 'likers', 'followers'],
    ...
    csvFields: ["id", "ownerId", "ownerUsername", "shortcode", "isVideo", "takenAtTimestamp", "takenAtGMT", "commentsDisabled", "thumbnailSrc", "url", "likes", "comments", "views"],
    csvCommentFields: ['id', 'text', 'created_at', 'did_report_as_spam', 'owner_id', 'owner_username', 'owner_is_verified', 'viewer_has_liked', 'likes'],
    csvLikersFields: ['user_id', 'username', 'full_name', 'profile_pic_url', 'is_private', 'is_verified', 'followed_by_viewer', 'requested_by_viewer'],
    hash: {
