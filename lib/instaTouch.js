...
class instaTouch extends EventEmitter {
    ...
    zipIt() {
        return new Promise(async (resolve, reject) => {
            ...
            const zip = this._filepath ? `${this._filepath}/${this._filename}_${this._date}.zip` : `${this._filename}_${this._date}.zip`;
        ...
        return new Promise(async (resolve, reject) => {
            if (!this._itemId) {
                try {
                    if (
                        ...
                        const edges = await this.graphqlQuery();
            ...
            if (!this._event) {
                try {
                    ...
                    const json = this._filepath ? `${this._filepath}/${this._filename}_${this._date}.json` : `${this._filename}_${this._date}.json`;
                    const csv = this._filepath ? `${this._filepath}/${this._filename}_${this._date}.csv` : `${this._filename}_${this._date}.csv`;
                    const zip = this._filepath ? `${this._filepath}/${this._filename}_${this._date}.zip` : `${this._filename}_${this._date}.zip`;
            ...
            for (let i = 0; i < edges.length; i++) {
                ...
                switch (this._scrapeType) {
                    ...
                    case 'location':
                        ...
                        } else if (this._type === 'image' || this._type === 'all') {
