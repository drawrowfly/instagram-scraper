    ...
    scrapeLocationInput(toJson){
        return new Promise( async (resolve, reject) => {
            ...
            try{
                ...
                this._hasNextPage = toJson.entry_data.LocationsPage[0].graphql.location.edge_location_to_media.page_info.has_next_page;
                this.count = toJson.entry_data.LocationsPage[0].graphql.location.edge_location_to_media.count;
                this._endCursor = toJson.entry_data.LocationsPage[0].graphql.location.edge_location_to_media.page_info.end_cursor;
            } catch(error){
    ...
    scrapeHashtagInput(toJson){
        return new Promise( async (resolve, reject) => {
            ...
            try{
                ...
                this._hasNextPage = toJson.entry_data.TagPage[0].graphql.hashtag.edge_hashtag_to_media.page_info.has_next_page;
                this.count = toJson.entry_data.TagPage[0].graphql.hashtag.edge_hashtag_to_media.count;
                this._endCursor = toJson.entry_data.TagPage[0].graphql.hashtag.edge_hashtag_to_media.page_info.end_cursor;
            } catch(error){
                return reject({ message: "Cant parse json" });
            }
    ...
    scrapeUserInput(toJson){
        return new Promise( async (resolve, reject) => {
            ...
            try{
                ...
                this._hasNextPage = toJson.entry_data.ProfilePage[0].graphql.user.edge_owner_to_timeline_media.page_info.has_next_page;
                this.count = toJson.entry_data.ProfilePage[0].graphql.user.edge_owner_to_timeline_media.count;
                this._endCursor = toJson.entry_data.ProfilePage[0].graphql.user.edge_owner_to_timeline_media.page_info.end_cursor;
            } catch(error){
                return reject({ message: "Cant parse json" });
            }
